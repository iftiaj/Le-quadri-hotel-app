...
class twin extends StatelessWidget {
  const twin({Key? key}) : super(key: key);
  @override
        ...
        body: SingleChildScrollView(
          ...
          children: <Widget>[
            ImageSlideshow(
              ...
              children: [
                Image.asset(
                  'assets/images/twin1.jpg',
                  fit: BoxFit.cover,
                ),
                Image.asset(
                  'assets/images/twin2.jpg',
                  fit: BoxFit.cover,
                ),
                Image.asset(
                  'assets/images/twin3.jpg',
                  fit: BoxFit.cover,
                ),
              ],
              onPageChanged: (value) {
